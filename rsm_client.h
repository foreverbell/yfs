...
rsm_client::call(unsigned int proc, const A1 &a1, const A2 &a2, const A3 &a3, const A4 &a4, R &r)
{
  marshall m;
  std::string rep;
  std::string res;
...
rsm_client::call(unsigned int proc, const A1 &a1, const A2 &a2, const A3 &a3, const A4 &a4, const A5 &a5, R &r)
{
  marshall m;
  std::string rep;
  std::string res;
