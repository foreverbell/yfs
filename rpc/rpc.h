...
class rpcc : public chanmgr {
 ...
 public:
  ...
  int call(unsigned int proc, const A1 & a1, const A2 & a2, const A3 & a3, const A4 & a4, const A5 & a5, const A6 & a6, R & r, TO to = to_max);

  template<class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
  int call(unsigned int proc, const A1 & a1, const A2 & a2, const A3 & a3, const A4 & a4, const A5 & a5, const A6 &a6, const A7 &a7, R & r, TO to = to_max);
};
...
rpcc::call(unsigned int proc, const A1 & a1, const A2 & a2, const A3 & a3, const A4 & a4, R & r, TO to)
{
  marshall m;
  m << a1;
  m << a2;
...
rpcc::call(unsigned int proc, const A1 & a1, const A2 & a2, const A3 & a3, const A4 & a4, const A5 & a5, R & r, TO to)
{
  marshall m;
  m << a1;
  m << a2;
...
template<class R, class A1, class A2, class A3, class A4, class A5, class A6> int
rpcc::call(unsigned int proc, const A1 & a1, const A2 & a2, const A3 & a3, const A4 & a4, const A5 & a5, const A6 & a6, R & r, TO to)
{
  marshall m;
  m << a1;
  m << a2;
...
template<class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7> int
rpcc::call(unsigned int proc, const A1 & a1, const A2 & a2, const A3 & a3, const A4 & a4, const A5 & a5, const A6 & a6, const A7 & a7, R & r, TO to)
{
  marshall m;
  m << a1;
  m << a2;
...
class rpcs : public chanmgr {
 ...
 private:
  ...
  rpcstate_t checkduplicate_and_update(
...
rpcs::reg(unsigned int proc, S*sob, int (S::*meth)(const A1 a1, const A2 a2, const A3 a3, const A4 a4, const A5 a5, const A6 a6, R & r))
{
  class h1 : public handler {
   private:
    S * sob;
    int (S::*meth)(const A1 a1, const A2 a2, const A3 a3, const A4 a4, const A5 a5, const A6 a6, R & r);

   public:
    h1(S *xsob, int (S::*xmeth)(const A1 a1, const A2 a2, const A3 a3, const A4 a4, const A5 a5, const A6 a6, R & r)) : sob(xsob), meth(xmeth) { }
...
template<class S, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class R> void
rpcs::reg(unsigned int proc, S*sob, int (S::*meth)(const A1 a1, const A2 a2, const A3 a3, const A4 a4, const A5 a5, const A6 a6, const A7 a7, R & r))
{
  class h1 : public handler {
   private:
    S * sob;
    int (S::*meth)(const A1 a1, const A2 a2, const A3 a3, const A4 a4, const A5 a5, const A6 a6, const A7 a7, R & r);

   public:
    h1(S *xsob, int (S::*xmeth)(const A1 a1, const A2 a2, const A3 a3, const A4 a4, const A5 a5, const A6 a6, const A7 a7, R & r)) : sob(xsob), meth(xmeth) { }
